...
class FavoritesViewController: UITableViewController, UITabBarControllerDelegate, HMAccessoryDelegate, HMHomeManagerDelegate {
    ...
    var showsFavorites = false {
        didSet {
            editButton.setTitle(showsFavorites ? NSLocalizedString("Done", comment: "Done") : NSLocalizedString("Edit Favourites", comment: "Edit Favourites"), forState: UIControlState.Normal)
